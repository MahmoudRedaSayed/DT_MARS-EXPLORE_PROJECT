...
//pure virtual function to the execute function to can be implamented in each drived class
	virtual viod Execute(PriorityQueue<Emergency_Mission*>& Eme_Missions,LinkedQueue<Polar_Mission*>& Pol_Missions , LinkedQueue<Mountainous_Mission*>& Mou_Missions) = 0;
